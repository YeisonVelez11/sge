...
texto= "esto es un texto, para el sr. gómez. Esto; es una prueba que puedes encontrar en www.google.com"
palabras_tokenizadas1=(word_tokenize(texto,"spanish"))
print(palabras_tokenizadas1)
